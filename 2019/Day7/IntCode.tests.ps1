Describe IntCode {
    Context 'Stream' {
        ...
        It 'ReadInt' {
            $computer.ReadInt() | Should -Be 1
            $computer.StreamPosition | Should -Be 1

            $computer.ReadInt() | Should -Be 0
            $computer.StreamPosition | Should -Be 2
        }

        It 'WriteInt' {
            $computer.WriteInt(1, 10)
    ...
    Context 'Programs' {
        ...
        It 'Highest value: <Program>: With <Value> returns <ExpectedValue>' -TestCases @(
            ...
            $amplifiers = for ($i = 0; $i -lt $Values.Count; $i++) {
                $intCode = [IntCode]::Init($Program)
                $intCode.AddInputValue($Values[$i])
                $intCode
            }
            ...
            $signal | Should -Be $ExpectedValue
        }
